...
Twenty-seven verbs: `status`, `fleets`, `cargo`, `market`, `markets`, `barpool`, `survey`, `visibility`, `colonizable`, `landmarks`, `entities`, `intel`, `feed`, `screen` read; `teleport`, `pause`, `ability`, `setcr`, `give`, `addship`, `objective`, `surveyset`, `expedition`, `rep`, `netfault`, `save`, `mark` act. Eleven of them carry shapes worth knowing before you diff two dumps:

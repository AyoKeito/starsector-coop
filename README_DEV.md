...
Twenty-one verbs: `status`, `fleets`, `cargo`, `market`, `markets`, `barpool`, `survey`, `visibility`, `colonizable`, `landmarks` read; `teleport`, `pause`, `ability`, `setcr`, `give`, `addship`, `objective`, `surveyset`, `expedition`, `rep`, `netfault` act. Seven of them carry shapes worth knowing before you diff two dumps:

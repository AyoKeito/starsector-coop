...
if not exist "%ROOT%\jre\bin\javaw.exe" (
    ...
    echo.
    echo    java -cp "%MOD_DIR%\jars\coop-launcher.jar;%MOD_DIR%\jars\flatlaf.jar;%MOD_DIR%\jars\coop.jar;%ROOT%\starsector-core\json.jar;%ROOT%\starsector-core\log4j-1.2.9.jar" coop.launcher.CoopLauncherApp
    echo.
    pause
    exit /b 1
)

start "" "%ROOT%\jre\bin\javaw.exe" -cp "%MOD_DIR%\jars\coop-launcher.jar;%MOD_DIR%\jars\flatlaf.jar;%MOD_DIR%\jars\coop.jar;%ROOT%\starsector-core\json.jar;%ROOT%\starsector-core\log4j-1.2.9.jar" coop.launcher.CoopLauncherApp
endlocal
